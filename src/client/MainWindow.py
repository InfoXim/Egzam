...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.ShowTables.clicked.connect(lambda: self.change_tab(0))
        self.ui.ShowStats.clicked.connect(lambda: self.change_tab(1))
        self.ui.Add.clicked.connect(self.open_new_window)
        self.ui.Update.clicked.connect(self.open_new_window)
        ...
        table_list.currentRowChanged.connect(self.table_select)
    ...
    def table_select(self, table_index):
